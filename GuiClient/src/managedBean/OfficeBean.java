...
public class OfficeBean {
	...
	public String loginIdentity() 
	{
		...
		try 
		{
			...
			if(identityDAORemote.hasOfficeAccount(identityDTO))
			{
				return "/userFilter/officeHome.xhtml?faces-redirect=true";
			}
			else
			{
				facesContext.addMessage("loginForm", new FacesMessage(FacesMessage.SEVERITY_ERROR, "You must have access to Microsoft Office 365 in order to access this page!", null));
				return null;
			}
		} 
